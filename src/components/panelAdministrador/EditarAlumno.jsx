...
import { editarAlumno, obtenerAlumno } from "../helpers/queries";
...
const EditarAlumno = () => {
    ...
    const {
      ...
      const onSubmit = (alumno) => {
        editarAlumno(alumno, materiasInscritas, documentos, id).then((respuesta) =>{
      ...
      useEffect(()=>{
        obtenerAlumno(id).then((respuesta) =>{
        setValue("nombres", respuesta.nombres);
        setValue("apellido", respuesta.apellido);
        setValue("dni", respuesta.dni);
        setValue("cuil", respuesta.cuil);
        setValue("fechaNac", respuesta.fechaNac);
        setValue("provincia", respuesta.provincia);
        setValue("domicilio", respuesta.domicilio);
        setValue("localidad", respuesta.localidad);
        setValue("celuPersonal", respuesta.celuPersonal);
        setValue("celuEmergencia", respuesta.celuEmergencia);
        setValue("email", respuesta.email);
        setValue("carrera", respuesta.carrera);
